// KiWIS_TimeSeries_TableModel - table model for the time series catalog
...
/**
This class is a table model for time series header information for KiWIS web services
time series.  By default the sheet will contain row and column numbers.
*/
@SuppressWarnings({ "serial", "rawtypes" })
public class KiWIS_TimeSeries_TableModel extends JWorksheet_AbstractRowTableModel {
	...
	*/
	...
	public KiWIS_TimeSeries_TableModel ( KiWISDataStore dataStore, List<? extends Object> data ) {
		if ( data == null ) {
			_rows = 0;
		}
		else {
