...
#   ./tstool/NN/plugins/owf-tstool-kiwis-plugin/ folder for use by TSTool
...
mavenProjectFolder=${repoFolder}/owf-tstool-kiwis-plugin
...
devBinFolder="${repoFolder}/owf-tstool-kiwis-plugin/target/classes"
pluginsFolder="$HOME/.tstool/${tstoolMajorVersion}/plugins"
jarFolder="${pluginsFolder}/owf-tstool-kiwis-plugin"
pluginDepFolder="${pluginsFolder}/owf-tstool-kiwis-plugin/dep"
jarFile="${jarFolder}/owf-tstool-kiwis-plugin-${pluginVersion}.jar"
manifestFile="${repoFolder}/owf-tstool-kiwis-plugin/src/main/resources/META-INF/MANIFEST.MF"
