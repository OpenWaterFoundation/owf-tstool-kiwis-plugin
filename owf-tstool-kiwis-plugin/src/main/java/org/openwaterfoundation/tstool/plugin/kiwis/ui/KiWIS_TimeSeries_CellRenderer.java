// KiWIS_TimeSeries_CellRenderer - renderer for the time series catalog table model
...
/**
This class is used to render cells for KiWIS_TimeSeries_TableModel data.
*/
@SuppressWarnings("serial")
public class KiWIS_TimeSeries_CellRenderer extends JWorksheet_AbstractExcelCellRenderer {

	private KiWIS_TimeSeries_TableModel tableModel = null;

	/**
	Constructor.
	@param tableModel The TSTool_ReclamationPisces_TableModel to render.
	*/
	public KiWIS_TimeSeries_CellRenderer ( KiWIS_TimeSeries_TableModel tableModel ) {
