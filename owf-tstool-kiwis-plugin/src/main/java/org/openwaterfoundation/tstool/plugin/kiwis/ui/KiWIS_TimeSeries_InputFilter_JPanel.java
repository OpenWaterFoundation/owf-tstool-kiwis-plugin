// KiWIS_TimeSeries_InputFilter_JPanel - panel to filter time series queries
...
package org.openwaterfoundation.tstool.plugin.kiwis.ui;
...
//import org.openwaterfoundation.tstool.plugin.kiwis.dao.TimeSeriesCatalogFilterType;
//import org.openwaterfoundation.tstool.plugin.kiwis.dao.Station;
//import org.openwaterfoundation.tstool.plugin.kiwis.util.IgnoreCaseComparator;
//import org.openwaterfoundation.tstool.plugin.kiwis.util.NumericalComparator;

/**
This class is an input filter for querying KiWIS web services.
*/
@SuppressWarnings("serial")
public class KiWIS_TimeSeries_InputFilter_JPanel extends InputFilter_JPanel {

	/**
	Test datastore, for connection.
	*/
	private KiWISDataStore datastore = null;

	/**
	Constructor for case when no datastore is configured - default panel.
	@param label label for the panel
	*/
	public KiWIS_TimeSeries_InputFilter_JPanel( String label ) {
		super(label);
	}
	...
	*/
	public KiWIS_TimeSeries_InputFilter_JPanel( KiWISDataStore dataStore, int numFilterGroups ) {
	    super();
	...
	*/
	public void setFilters ( int numFilterGroups ) {
		...
		try {
			...
			Message.printWarning(2, routine, "Exception reading the KiWIS time series list");
	...
	@return the data store corresponding to this input filter panel.
	*/
	public KiWISDataStore getDataStore ( ) {
