...
#
#     TSTool 15:
#       ./tstool/NN/plugins/owf-tstool-kiwis-plugin/1.2.3/
#
...
mainPluginFolder="${pluginsFolder}/owf-tstool-kiwis-plugin"

# Version installed folder for the plugin.
versionPluginFolder="${mainPluginFolder}/${pluginVersion}"

# Plugin Jar file.
jarFile="${versionPluginFolder}/owf-tstool-kiwis-plugin-${pluginVersion}.jar"
